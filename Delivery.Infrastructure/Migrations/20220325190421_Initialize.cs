        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Borough = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    ...
                    Block = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    ...
                    AddInfo = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    DeliveryUserId = table.Column<string>(type: "nvarchar(36)", maxLength: 36, nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedOn = table.Column<DateTime>(type: "datetime2", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserId = table.Column<string>(type: "nvarchar(36)", nullable: false),
                    RoleId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    DeliveryUserId = table.Column<string>(type: "nvarchar(36)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AspNetUserRoles_AspNetUsers_DeliveryUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddInfo = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    DeliveryUserId = table.Column<string>(type: "nvarchar(36)", maxLength: 36, nullable: true),
                    AddressId = table.Column<string>(type: "nvarchar(36)", maxLength: 36, nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                    MinutesForDelivery = table.Column<int>(type: "int", nullable: false),
                    ProcessingTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    OnDeliveryTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeliveredTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeliveryTaxId = table.Column<int>(type: "int", nullable: true),
                    CustomerComment = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price = table.Column<decimal>(type: "decimal(7,2)", nullable: false),
                    Weight = table.Column<int>(type: "int", nullable: false),
                    MaxProductsInPackage = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllergenId = table.Column<string>(type: "nvarchar(36)", maxLength: 36, nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedOn = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExtraItems", x => new { x.ShopingCartItemId, x.ExtraId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExtraItems_ShoppingCartItems_ShopingCartItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUserRoles_DeliveryUserId",
